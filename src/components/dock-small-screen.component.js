                                ...
                                <Grid container direction="column" justify="center" alignItems="flex-start" style={{ width: "100%" }} spacing={2}>
                                    ...
                                    <Grid item style={{ width: "100%" }}>
                                        <Grid container direction="column" justify="center" alignItems="flex-start" style={{ width: "100%" }} spacing={2}>
                                            ...
                                            <Grid item>
                                                <ButtonE onClick={() => { setOpenSchemaDialog(true) }} appearance="primary" style={{ fontSize: "0.825rem", padding: "10px", marginTop: "5px", color: colors.bwg.accentColor, backgroundColor: colors.blue.backgroundColor, borderColor: colors.blue.backgroundColor, fontFamily: "Work Sans" }}>
                                                    View Schema
                                                </ButtonE>
                                                <Dialog
                                                ...
                                                >
                                                    <div style={{ padding: "0px" }}>
                                                        <Grid container direction="column" justify="center" alignItems="stretch" spacing={2}>
                                                            <Grid item>
                                                                <Typography style={{ fontSize: "1.25rem", fontFamily: "Work Sans", color: colors.red.accentColor, fontWeight: "500" }}>
                                                                    {collection}
                                                                </Typography>
                                                            </Grid>
                                                            <Grid item >
                                                                    ...
                                                                    <TableE.Body>
                                                                        {
                                                                            data ? Object.keys(data.schema).map((scheme) => (
                                                                                <TableE.Row isSelectable onSelect={() => setDisplayableScheme({ key: scheme, value: data.schema[scheme] })}>
                                                                                    ...
                                                                                    <TableE.TextCell style={{ overflow: "auto" }}>{data.schema[scheme]}</TableE.TextCell>
                                                                                </TableE.Row>
                                                                            )) : undefined
                                                                        }
                                                                    </TableE.Body>
                                        ...
                                        {data ?
                                            ...
                                            <div style={{ padding: "10px", height: "80vh", width: "100%" }}>
                                                <Grid container direction="column" alignItems="center" justify="center" style={{ width: "100%", height: "100%" }}>
                                                    <Grid item style={{ width: "100%" }}>
                                                        <center>
                                                            <img src={datamiss} style={{ width: "100%" }} />
                                                        </center>
                                                    </Grid>
                                                    <Grid item >
